...
Every pair differs in at least two ways. The near cases: arm vs bonder share a hue family and value (brass 26° / 0.09 against terracotta 10° / 0.19) and are told apart by shape and marking; bonder vs second bond are told apart by hue, shape, and marking; the three output tiers share glaze and value and are told apart by size, seven, nineteen and thirty-seven cells, and by texture; the texture term is judged on a sixteen-pixel thumbnail of each sprite, since at eight the second and third tiers, whose cups differ two to one in size, read as one ivory blur; source vs cleanup share a footprint and are told apart by hue and marking.
