...
The output is a two-cell ivory receiving station: two protected cups, a bond-checking bridge, paired rails, and one covered exit chute. It looks receptive rather than transformative. `proposal-output-2.png` is landed for its clean paired seats and inspection bridge; `proposal-output-1.png` explores a larger surrounding rack.
